...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','nl.totalactivemedia.ti.proxysettingreader.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','NlTotalactivemediaTiProxysettingreaderModuleAssets.m')
